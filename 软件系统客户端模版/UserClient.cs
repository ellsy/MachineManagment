...
namespace 软件系统客户端模版
{
    ...
    public class UserClient
    {
        ...
        /// </summary>
        public static BasicFramework.SystemVersion CurrentVersion { get; } = new BasicFramework.SystemVersion("3.0.0");
        ...
        public static BasicFramework.ClassSystemVersion HistoryVersions { get; } = new BasicFramework.ClassSystemVersion()
        {
            Versions = new List<BasicFramework.VersionInfo>()
            {
                ...
                {
                    VersionNum=new BasicFramework.SystemVersion("3.0.0"),
        ...
        /// 服务器的时间搓，应该定期和服务器更新
        /// </summary>
        public static DateTime DateTimeServer { get; set; } = DateTime.Now.Date;
        ...
        /// 当前系统的登录账户
        /// </summary>
        public static UserAccountEx UserAccount { get; set; } = new UserAccountEx();
